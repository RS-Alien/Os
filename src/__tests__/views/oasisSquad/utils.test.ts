...
import { getAltText, getEventStepStatus, getEventText } from 'views/OasisSquad/utils'

const HOUR_IN_MS = 3600 * 1000

describe('OasisSquad/utils/getEventStepStatus', () => {
...
describe('OasisSquad/utils/getEventText', () => {
  it('Should return past status', () => {
    // Given
    const eventStatus = [SaleStatusEnum.Presale, SaleStatusEnum.Sale]
    const saleStatus = SaleStatusEnum.Claim
...
describe('OasisSquad/utils/getAltText', () => {
