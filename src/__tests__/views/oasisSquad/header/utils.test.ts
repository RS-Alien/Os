import { ButtonsEnum } from 'views/OasisSquad/components/Header/types'
import { getCurrentButton } from 'views/OasisSquad/components/Header/utils'
import { SaleStatusEnum, UserStatusEnum } from 'views/OasisSquad/types'

describe('OasisSquad/Header/utils/getCurrentButton', () => {
