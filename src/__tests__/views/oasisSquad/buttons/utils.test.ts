import { BuyButtonsEnum } from 'views/OasisSquad/components/Buttons/types'
import { getBuyButton, getBuyButtonText } from 'views/OasisSquad/components/Buttons/utils'
import { SaleStatusEnum } from 'views/OasisSquad/types'

describe('OasisSquad/buttons/utils/getBuyButtonText', () => {
...
describe('OasisSquad/buttons/utils/getBuyButton', () => {
