...
import { OasisSquadContext } from 'views/OasisSquad/context'
...
const BuyTicketsButtons: React.FC<BuyTicketsProps> = ({
  ...
  const { isUserEnabled, setIsUserEnabled } = useContext(OasisSquadContext)
  ...
  const { isApproving, isApproved, isConfirming, handleApprove, handleConfirm, hasApproveFailed, hasConfirmFailed } =
    useApproveConfirmTransaction({
      ...
      onApprove: () => {
        return callWithGasPrice(osContract, 'approve', [nftSaleContract.address, MaxUint256])
      },
