...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Oasis Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Oasis Bunny NFTs at the snapshot may also purchase one additional Oasis Squad NFT in the presale for each Oasis Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of OS spent on Oasis Squad NFTs will be burned as part of our weekly OS burn.')],
  },
  {
