...
import { StyledWaveContainer } from 'views/OasisSquad/styles'
import { UserStatusEnum } from 'views/OasisSquad/types'
...
import { OasisSquadHeaderType } from './types'

const DEFAULT_OS_COST = 15
const DEFAULT_MAX_TICKETS = 10

const OasisSquadHeader: React.FC<OasisSquadHeaderType> = ({
  userInfos,
  eventInfos,
  account,
  userStatus,
...
export default OasisSquadHeader
