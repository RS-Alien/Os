...
import { StyledWaveContainer, LandingBodyWrapper } from 'views/OasisSquad/styles'
    ...
    <StyledEventStepsSectionContainer justifyContent="center" $isDark={isDark}>
      ...
      <StyledWaveContainer bottom="-3px">
        <Flex justifyContent="center">
          <StyledBunniesSquadImg src="/images/oasisSquad/squadRow.png" alt="Oasis bunnies squad" />
        </Flex>
