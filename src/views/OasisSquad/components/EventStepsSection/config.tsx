...
import { SaleStatusEnum, UserStatusEnum } from 'views/OasisSquad/types'
  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active OasisSwap Profile to buy Minting Tickets and mint a Oasis Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      buttons: (
        <>
          <Button
            as="a"
            href="https://Oasisswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82"
            target="_blank"
            width="100%"
          >
            {t('Buy OS')}
    ...
    },
    {
      ...
      bodyText: [
        ...
        `04:00 UTC, Oct. 7 ${t(
          'Pre-sale: Wallets which held “Gen 0” Oasis Bunnies NFTs (bunnyID 0,1,2,3,4) at a snapshot taken some time between 12 and 2 hours before the presale begins can purchase one Squad Ticket per Gen 0 NFT.',
        )}`,
        `08:00 UTC, Oct. 7 ${t(
          'Public Sale: Any wallet with an active Oasis Profile can purchase up to 10 Squad Tickets, while stocks last.',
        )}`,
      ],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Claim Phase'),
      bodyText: [
        t('During this phase, any wallet holding a Squad Ticket can redeem their ticket to claim a Oasis Squad NFT.'),
      ],
      buttons: (
        <>
          {hasData && (
