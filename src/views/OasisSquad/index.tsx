...
import OasisSquadHeader from './components/Header'
import { OasisSquadContext } from './context'
...
const OasisSquad: React.FC = () => {
  ...
  return (
    <OasisSquadContext.Provider value={{ isUserEnabled, setIsUserEnabled }}>
