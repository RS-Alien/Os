...
import { getOasisSquadContract } from 'utils/contractHelpers'
  ...
  useEffect(() => {
    const fetchUserInfos = async () => {
      try {
        ...
        const oasisSquadContract = getOasisSquadContract()
        ...
        if (account) {
          ...
          const currentNumberTokensOfUser = await oasisSquadContract.balanceOf(account)
