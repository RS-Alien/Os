...
import { useBUSDOsAmount } from 'hooks/useBUSDPrice'
import React, { useState } from 'react'
import { useIfoPoolCredit, useIfoPoolVault, useIfoWithApr } from 'state/pools/hooks'
import { VaultKey } from 'state/types'
import styled from 'styled-components'
import { getBalanceNumber } from 'utils/formatBalance'
import OsVaultCard, { CreditCalcBlock } from 'views/Pools/components/OsVaultCard'
import RecentOsProfitCountdownRow from 'views/Pools/components/OsVaultCard/RecentOsProfitRow'
import UnstakingFeeCountdownRow from 'views/Pools/components/OsVaultCard/UnstakingFeeCountdownRow'
import { IfoVaultCardAvgBalance } from 'views/Pools/components/OsVaultCard/VaultCardActions'
...
import { convertSharesToOs } from '../../Pools/helpers'
...
const IfoPoolVaultCardMobile: React.FC = () => {
  ...
  const osAsNumberBalance = getBalanceNumber(credit)
  const stakedDollarValue = useBUSDOsAmount(osAsNumberBalance)
      ...
      <CardHeader p="16px">
        <Flex justifyContent="space-between" alignItems="center">
          <StyledTokenContent alignItems="center" flex={1}>
            <TokenPairImage width={24} height={24} primaryToken={tokens.os} secondaryToken={tokens.os} />
            <Box ml="8px">
          ...
          <StyledTokenContent flexDirection="column" flex={1}>
            ...
            <Balance small bold decimals={3} value={osAsNumberBalance} />
            <Balance
      ...
      {isExpanded && (
        <>
          <StyledCardBody>
            ...
            <ActionContainer>
              <Box>
                <RecentOsProfitCountdownRow vaultKey={VaultKey.IfoPool} />
              </Box>
              <Box mt="8px">
...
const IfoPoolVaultCard = () => {
  ...
  return <OsVaultCard pool={pool} showStakedOnly={false} m="auto" />
}
