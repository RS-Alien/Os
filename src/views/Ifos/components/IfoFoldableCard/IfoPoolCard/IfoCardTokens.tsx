          ...
          <Box>
            <MessageText display="inline">
              {publicIfoData.status === 'finished'
                ? t('Activate OasisSwap Profile to take part in next IFO‘s!')
                : t('You need an active OasisSwap Profile to take part in an IFO!')}
            </MessageText>{' '}
    ...
    if (ifo.version === 3 && getBalanceNumber(credit) === 0) {
      message = (
        <Message my="24px" p="8px" variant="danger">
          <Box>
            <MessageText display="inline">
              {t('You don’t have any average OS balance available to commit in the IFO OS pool.')}
            </MessageText>{' '}
      ...
      return userPoolCharacteristics.amountTokenCommittedInLP.isEqualTo(0) ? (
        <Flex flexDirection="column" alignItems="center">
          ...
          <Text textAlign="center" fontSize="14px">
            {t('To participate in the next IFO, stake some OS in the IFO OS pool!')}
          </Text>
