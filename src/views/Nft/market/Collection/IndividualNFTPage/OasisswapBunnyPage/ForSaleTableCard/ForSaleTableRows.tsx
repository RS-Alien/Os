...
const Row: React.FC<RowProps> = ({ t, nft, roseBusdPrice, account, onSuccessSale }) => {
  const priceInUsd = multiplyPriceByAmount(roseBusdPrice, parseFloat(nft.marketData.currentAskPrice))
