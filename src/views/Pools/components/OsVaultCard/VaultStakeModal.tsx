...
const VaultStakeModal: React.FC<VaultStakeModalProps> = ({
  ...
  const usdValueStaked = new BigNumber(stakeAmount).times(osPriceBusd)
  const formattedUsdValueStaked = osPriceBusd.gt(0) && stakeAmount ? formatNumber(usdValueStaked.toNumber()) : ''
  ...
  return (
    ...
    >
      ...
      <BalanceInput
        ...
        currencyValue={osPriceBusd.gt(0) && `~${formattedUsdValueStaked || 0} USD`}
