...
interface OsVaultProps extends CardProps {
  ...
  const { tooltip, tooltipVisible, targetRef } = useTooltip(
    hasEndBlockOver ? (
      <>
        ...
        <LinkExternal href="https://twitter.com/oasisswap">
      ...
      <>
        <Text>
          {t(
            'The start block of the current calculation period. Your average IFO OS Pool staking balance is calculated throughout this period.',
          )}
        </Text>
        <LinkExternal href="https://medium.com/oasisswap/initial-farm-offering-ifo-3-0-ifo-staking-pool-622d8bd356f1">
...
const OsVaultCard: React.FC<OsVaultProps> = ({ pool, showStakedOnly, defaultFooterExpanded, ...props }) => {
  const { t } = useTranslation()
    ...
    <StyledCard isActive {...props}>
      ...
      <StyledCardBody isLoading={isLoading}>
        ...
        <FlexGap mt="16px" gap="24px" flexDirection={accountHasSharesStaked ? 'column-reverse' : 'column'}>
          <Box>
            <Box mt="24px">
              <RecentOsProfitRow vaultKey={pool.vaultKey} />
            </Box>
            <Box mt="8px">
