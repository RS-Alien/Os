...
const HarvestCard = () => {
  ...
  const earningsBusd = new BigNumber(farmEarningsSum).multipliedBy(osPriceBusd)
  ...
  const earningsText = getEarningsText(numFarmsToCollect, hasOsPoolToCollect, earningsBusd, t)
